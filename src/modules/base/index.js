...
let module = angular.module('app.base', [])
    ...
    .directive('cBadgesGrid', require('./components/badges/badges-grid').default)
    .directive('cCustomerLogin', require('./components/customer/customer-login').default)
    .directive('cCustomerRegister', require('./components/customer/customer-register').default)
    .directive('cCustomerUpdate', require('./components/customer/customer-update').default)
    .directive('cCustomerNav', require('./components/customer/customer-nav').default)
    .directive('cCustomerLogout', require('./components/customer/customer-logout').default)
    .directive('cCustomerReset', require('./components/customer/customer-reset').default)
    .directive('cCustomerActivate', require('./components/customer/customer-activate').default)
